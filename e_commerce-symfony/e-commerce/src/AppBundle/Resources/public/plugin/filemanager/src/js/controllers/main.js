(function(window, angular, $) {
    ...
    angular.module('FileManagerApp').controller('FileManagerCtrl', [
        '$scope', '$translate', 'fileManagerConfig', 'item', 'fileNavigator', 'fileUploader', 'mediaArticle',
        function($scope, $translate, fileManagerConfig, Item, FileNavigator, FileUploader, MediaArticle) {
        ...
        $scope.mediaArticle = MediaArticle;
        ...
        {
            console.log($scope.mediaArticle.addMediaArticle(e));
